# CEGATSR
Implementation of CNN-Enhanced Graph Attention Network for Hyperspectral Image Super-Resolution Using Non-Local Self-Similarity (CEGATSR) [Paper Address](https://doi.org/10.1080/01431161.2022.2121188) in Pytorch. [Paper PDF Download](https://github.com/Dongyx1128/CEGATSR/raw/main/CEGATSR-Dongyx1128.pdf).
...
```
[1] Cong Liu & Yaxin Dong (2022) CNN-Enhanced graph attention network for hyperspectral image super-resolution using non-local self-similarity, International Journal of Remote Sensing, 43:13, 4810-4835, DOI: 10.1080/01431161.2022.2121188
```
